...
function setupUI({ waterResolution, water, ground }) {
  ...
  geometryFolder.addInput(waterResolution, 'size', { 
  ...
  wavesFolder.addInput(water.material.uniforms.uWavesAmplitude, 'value', {
    min: 0, max: 0.1, label: 'Amplitude'
  });
  wavesFolder.addInput(water.material.uniforms.uWavesFrequency, 'value', {
    min: 0.1, max: 10, label: 'Frequency'
  });
  wavesFolder.addInput(water.material.uniforms.uWavesPersistence, 'value', {
    min: 0, max: 1, label: 'Persistence'
  });
  wavesFolder.addInput(water.material.uniforms.uWavesLacunarity, 'value', {
    min: 0, max: 3, label: 'Lacunarity'
  });
  wavesFolder.addInput(water.material.uniforms.uWavesIterations, 'value', {
    min: 1, max: 10, step: 1, label: 'Iterations'
  });
  wavesFolder.addInput(water.material.uniforms.uWavesSpeed, 'value', {
    min: 0, max: 1, label: 'Speed'
  });

  const colorFolder = waterFolder.addFolder({ title: 'Color' });
  colorFolder.addInput(water.material.uniforms.uOpacity, 'value', {
    min: 0, max: 1, step: 0.01, label: 'Opacity'
  });

  colorFolder.addInput(water.material.uniforms.uTroughColor, 'value', {
    label: 'Trough Color', view: 'color', color: { type: 'float' }
  });
  colorFolder.addInput(water.material.uniforms.uSurfaceColor, 'value', {
    label: 'Surface Color', view: 'color', color: { type: 'float' }
  });
  colorFolder.addInput(water.material.uniforms.uPeakColor, 'value', {
    label: 'Peak Color', view: 'color', color: { type: 'float' }
  });
  colorFolder.addInput(water.material.uniforms.uPeakThreshold, 'value', {
    min: 0, max: 0.5, label: 'Peak Threshold'
  });
  colorFolder.addInput(water.material.uniforms.uPeakTransition, 'value', {
    min: 0, max: 0.5, label: 'Peak Transition'
  });
  colorFolder.addInput(water.material.uniforms.uTroughThreshold, 'value', {
    min: -0.5, max: 0, label: 'Trough Threshold'
  });
  colorFolder.addInput(water.material.uniforms.uTroughTransition, 'value', {
    min: 0, max: 0.5, label: 'Trough Transition'
  });

  const fresnelFolder = waterFolder.addFolder({ title: 'Fresnel' });
  fresnelFolder.addInput(water.material.uniforms.uFresnelScale, 'value', {
    min: 0, max: 1, label: 'Scale'
  });
  fresnelFolder.addInput(water.material.uniforms.uFresnelPower, 'value', {
    min: 0, max: 3, label: 'Power'
  });

  const causticsFolder = waterFolder.addFolder({ title: 'Caustics' });
  causticsFolder.addInput(ground.material.uniforms.uCausticsColor, 'value', {
    label: 'Color', view: 'color', color: { type: 'float' }
  });
  causticsFolder.addInput(ground.material.uniforms.uCausticsIntensity, 'value', {
    min: 0, max: 2, label: 'Intensity'
  });
  causticsFolder.addInput(ground.material.uniforms.uCausticsScale, 'value', {
    min: 0, max: 200, label: 'Scale'
  });
  causticsFolder.addInput(ground.material.uniforms.uCausticsSpeed, 'value', {
    min: 0, max: 1, label: 'Speed'
  });
  causticsFolder.addInput(ground.material.uniforms.uCausticsOffset, 'value', {
